package com.tinuvile.domain.activity.service.quota.rule.impl;
...
import com.tinuvile.domain.activity.service.quota.rule.AbstractActionChain;
...
public class ActivityBaseActionChain extends AbstractActionChain {
    ...
    public boolean action(ActivitySkuEntity activitySkuEntity, ActivityEntity activityEntity, ActivityCountEntity activityCountEntity) {
        ...
        log.info("活动责任链 - 基础信息【有效期、状态、库存(sku)】校验开始。sku:{}, activityId:{}", activitySkuEntity.getSku(), activitySkuEntity.getActivityId());
