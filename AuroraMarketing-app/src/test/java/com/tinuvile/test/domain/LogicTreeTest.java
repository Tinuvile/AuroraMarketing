...
public class LogicTreeTest {
    ...
    public void test_tree_lock() {
        ...
        ruleTreeVO.setTreeId(1000001);
        ruleTreeVO.setTreeName("决策树规则；增加画图模型");
        ruleTreeVO.setTreeDesc("决策树规则；增加画图模型");
        ...
        DefaultTreeFactory.StrategyAwardData data = treeEngine.process("Tinuvile", 10001L, 100);
