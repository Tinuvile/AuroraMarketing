...
-- 导出  表 aurora-marketing-02.raffle_activity_account_flow_000 结构
...
-- 正在导出表  aurora-marketing-02.raffle_activity_account_flow_000 的数据：~0 rows (大约)

-- 导出  表 aurora-marketing-02.raffle_activity_account_flow_001 结构
...
-- 正在导出表  aurora-marketing-02.raffle_activity_account_flow_001 的数据：~0 rows (大约)

-- 导出  表 aurora-marketing-02.raffle_activity_account_flow_002 结构
...
-- 正在导出表  aurora-marketing-02.raffle_activity_account_flow_002 的数据：~0 rows (大约)

-- 导出  表 aurora-marketing-02.raffle_activity_account_flow_003 结构
...
-- 正在导出表  aurora-marketing-02.raffle_activity_account_flow_003 的数据：~0 rows (大约)
