...
-- 导出  表 aurora-marketing-02.raffle_activity_account_flow 结构
...
-- 正在导出表  aurora-marketing-02.raffle_activity_account_flow 的数据：~0 rows (大约)

-- 导出  表 aurora-marketing-02.raffle_activity_order 结构
...
-- 正在导出表  aurora-marketing-02.raffle_activity_order 的数据：~0 rows (大约)
