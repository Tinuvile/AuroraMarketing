...
import com.tinuvile.domain.rebate.repository.IBehaviorRebateRepository;
import com.tinuvile.infrastructure.event.EventPublisher;
import com.tinuvile.infrastructure.persistent.dao.IDailyBehaviorRebateDao;
import com.tinuvile.infrastructure.persistent.dao.ITaskDao;
import com.tinuvile.infrastructure.persistent.dao.IUserBehaviorRebateOrderDao;
        ...
        try {
            ...
            transactionTemplate.execute(status -> {
                try {
                    ...
                    throw new AppException(ResponseCode.INDEX_DUPLICATE.getCode(), ResponseCode.INDEX_DUPLICATE.getInfo());
                }
            });
        } finally {
            dbRouter.clear();
